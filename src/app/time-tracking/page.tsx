...
export default function TimeTrackingPage() {
  ...
  return (
    <div className="h-screen flex flex-col space-y-4 p-4">
      ...
      <div className="grid grid-cols-3 gap-4 flex-1 min-h-0 max-h-[calc(100vh-300px)]">
        {/* Left Column - All Employee Shifts */}
        <div className="bg-white/90 backdrop-blur-xl rounded-xl border border-gray-200/50 shadow-lg flex flex-col h-full max-h-full">
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden" style={{ maxHeight: 'calc(100% - 80px)' }}>
