        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center px-4 py-3 rounded-2xl bg-white border border-gray-200 text-gray-700 font-medium shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105 group"
            >
              <ChartBarIcon className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform duration-200" />
              {t('view_entries', 'View Entries')}
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-200/50 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-white/70 backdrop-blur-sm focus:ring-2 focus:ring-[#31BCFF]/50 focus:border-[#31BCFF]"
            />
          </div>
            ...
            <div>
              ...
              <div className="mt-2 flex gap-2">
                <button
                  ...
                  className="text-xs text-[#31BCFF] hover:underline"
                >
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">
                ...
                {selectedEmployees.length > 0 && (
                  <span className="ml-2 text-[#31BCFF] text-xs">
              ...
              <div className="flex gap-2 mb-3">
                <button
                  ...
                  className="text-xs bg-[#31BCFF] text-white px-3 py-1 rounded-md hover:bg-[#31BCFF]/90"
                >
        ...
        <div className="flex gap-3 mt-6">
          <button
            ...
            disabled={loading}
            className="inline-flex items-center justify-center px-6 py-3 rounded-2xl bg-white border border-gray-200 text-gray-700 font-medium shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105 group disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <EyeIcon className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform duration-200" />
          ...
          <button
            ...
            disabled={loading}
            className="inline-flex items-center justify-center px-6 py-3 rounded-2xl bg-gradient-to-r from-[#31BCFF] to-[#0EA5E9] text-white font-medium shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 group disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <ChartBarIcon className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform duration-200" />
          ...
          {reportData && (
            <button
              onClick={exportToCSV}
              className="inline-flex items-center justify-center px-6 py-3 rounded-2xl bg-green-600 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 group"
            >
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-200/50 shadow-lg">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{t('total_employees', 'Total Employees')}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-200/50 shadow-lg">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{t('total_hours', 'Total Hours')}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-200/50 shadow-lg">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{t('total_gross_pay', 'Total Gross Pay')}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-200/50 shadow-lg">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{t('total_net_pay', 'Total Net Pay')}</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <tbody className="divide-y divide-gray-200">
                  {Object.entries(reportData.summary.byDepartment).map(([deptId, dept]) => (
                    <tr key={deptId}>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-900">{dept.totalHours.toFixed(1)}h</td>
                      <td className="px-4 py-3 text-sm text-gray-900">${dept.totalGrossPay.toFixed(2)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900">${dept.totalNetPay.toFixed(2)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
                    ...
                    <tr key={entry.id} className="hover:bg-blue-50/30 transition-colors duration-200">
                      <td className="px-6 py-4">
                        <div>
                          ...
                          {entry.employee.employeeNo && (
                            <div className="text-sm text-gray-500">#{entry.employee.employeeNo}</div>
                          )}
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-900">{entry.employee.department.name}</div>
                        {entry.employee.employeeGroup && (
                          <div className="text-sm text-gray-500">{entry.employee.employeeGroup.name}</div>
                        )}
                      </td>
                      <td className="px-6 py-4">
