...
export default function DashboardNavbar() {
  ...
  return (
    <>
      <nav className="hidden xl:block bg-white/80 backdrop-blur-xl border-b border-gray-200/50 shadow-lg fixed w-full z-30">
        <div className="px-6 h-18 flex items-center justify-between">
          {/* Left section with logo */}
          <div className="flex items-center">
            <Link href="/dashboard" className="text-2xl font-bold bg-gradient-to-r from-[#31BCFF] to-[#0EA5E9] bg-clip-text text-transparent ml-2 xl:ml-0 hover:scale-105 transition-transform duration-200">
              {APP_NAME}
            </Link>
          </div>
      ...
      <div className="xl:hidden fixed top-0 inset-x-0 z-30 bg-white/95 backdrop-blur-xl border-b border-gray-200/70 shadow-lg">
      ...
      <div className="xl:hidden fixed bottom-0 inset-x-0 z-30" aria-label="Primary navigation">
