                    ...
                    <div className="flex items-center gap-2.5 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-gray-500">
                          {getEmployeeTotalHours(employee.id)} / {employeeShiftsCount} Shift{employeeShiftsCount !== 1 ? 's' : ''}
                        </div>
                      </div>
                    </div>
                  </div>
                            ...
                            <div className="aspect-square">
                              {dayShifts.length === 0 ? (
                                ...
                                <div className="w-full h-full flex flex-col">
                                  ...
                                  {dayShifts.length > 1 && (
                                    <span className="w-full text-xs text-center text-gray-600 font-semibold mt-1">
            ...
            <div className="grid border-b bg-yellow-50" style={desktopGridStyle}>
              <div className="p-3 border-r">
                ...
                <div className="text-xs text-yellow-600 mt-0.5">
                  {unassignedShifts.length} Shift{unassignedShifts.length !== 1 ? 's' : ''} without employee
                </div>
              </div>
