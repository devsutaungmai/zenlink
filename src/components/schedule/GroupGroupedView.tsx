...
export default function GroupGroupedView({
  ...
  const handleShowMoreShifts = (shifts: ShiftWithRelations[], date: Date, groupName: string) => {
    setModalState({
      isOpen: true,
      shifts,
      date,
                          ...
                          <div className="min-h-[60px]">
                            {dayShifts.length === 0 ? (
                              ...
                              <div className="w-full h-full flex flex-col gap-1">
                                ...
                                {dayShifts.length > 1 && (
                                  <button 
                                    onClick={() => handleShowMoreShifts(dayShifts, date, group.name)}
          ...
          return (
            ...
            >
              ...
              {weekDates.map((date, dateIndex) => {
                ...
                const cellId = `grp-${group.id}-${formattedDate}`
                ...
                return (
                  <div
                    ...
                    onDragLeave={handleDragLeave}
                    onDrop={(e) => handleDrop(e, group.id, formattedDate, 'group')}
                  >
